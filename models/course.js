...
const Course = db.model("Course",{
    ...
    number: {type:Number, min:0, max:999, required:true}, // have to append zeros on frontend for courses like 023 or 043
    description: String,
    credits: {type:Number, min:1, max:5, required:true},
